...
export declare type SearchIndexLib = (givenOptions: Options, moduleReady: (err: Error, searchIndex: Index) => void) => void
 ...
 */
export declare function SearchIndex(givenOptions: Options, moduleReady: (err: Error, searchIndex: Index) => void): void
 ...
 */
export declare type Query = QueryObject | Array<QueryObject>
...
export declare class IndexingOptions {
...
export declare class ReadableStream2 extends EventEmitter {
    readable: boolean;
...
export declare class WritableStream extends EventEmitter {
    writable: boolean;
